...
reviewRouter.post("/", authMiddleware, upload.array("images", 5), validateReview, createReview)
...
reviewRouter.put("/:id", authMiddleware, upload.array("images", 5), validateReview, updateReview)
